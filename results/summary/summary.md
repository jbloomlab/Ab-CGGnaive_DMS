...
3.  [Prep Titseq Barcodes](prep_Titeseq_barcodes.md) produces
    [prepped barcode counts](../aggregated_counts/prepped_barcode_counts.csv) and 
    [prepped variant counts](../aggregated_counts/prepped_variant_counts.csv).
...
4.  [Tite-seq modeling](../Titeseq_modeling/final_variant_scores.csv).
    This notebook fits a model to the Tite-seq data to estimate the binding affinity of each variant to the CGG antibody.
    The results are recorded in [this file](../Titeseq_modeling/final_variant_scores.csv).
...
9.  [Derive final genotype-level phenotypes from replicate barcoded sequences](collapse_scores.md).
