...
```{r plot_correlations, echo=T, fig.width=9, fig.height=3, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(1,3))
...
```{r scatters_mut_effects_on_phenos, echo=T, fig.width=8, fig.height=8, fig.align="center", dpi=300,dev="png"}
...
```
Make heatmaps showing raw affinity and delta-affinity of muts relative to wildtype

```{r heatmap_DMS_log10Ka, fig.width=30,fig.height=6,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_delta-log10Ka-by-target, fig.width=30,fig.height=6,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_delta-log10Ka-by-target_singlent, fig.width=30,fig.height=6,fig.align="center", dpi=500,dev="png",echo=T}
p1 <- ggplot(temp[measurement=="delta_bind" & chain != "link",],aes(position_IMGT,mutant))+geom_tile(aes(fill=value),color="black",lwd=0.1)+
  scale_fill_gradientn(colours=c("#A94E35","#A94E35","#F48365","#FFFFFF","#7378B9","#383C6C"),limits=c(-7,3),values=c(0/10,1/10,3.5/10,7/10,8.5/10,10/10),na.value="yellow")+
  #scale_x_continuous(expand=c(0,0),breaks=c(1,seq(5,235,by=5)))+
  labs(x="",y="")+theme_classic(base_size=9)+
...
```{r heatmap_DMS_delta-polyspecificity-by-target_singlent, fig.width=30,fig.height=6,fig.align="center", dpi=500,dev="png",echo=T}
p1 <- ggplot(temp[measurement=="delta_psr" & chain != "link",],aes(position_IMGT,mutant))+geom_tile(aes(fill=value),color="black",lwd=0.1)+
  scale_fill_gradientn(colours=c("#383C6C","#7378B9","#FFFFFF","#F48365","#A94E35","#A94E35"),limits=c(-2,3),values=c(0/5,1/5,2/5,3/5,4/5,5/5),na.value="yellow")+
  #scale_x_continuous(expand=c(0,0),breaks=c(1,seq(5,235,by=5)))+
  labs(x="",y="")+theme_classic(base_size=9)+
